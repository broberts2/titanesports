	...
	return (
		...
		>
			...
			>
				...
				Tournament! In addition to filling out this application form, we ask for
				all players/teams to please join the Titan Esports Discord (
				<a href={"https://discord.gg/3g987Uz2"}>https://discord.gg/3g987Uz2</a>
			...
			<Utils.Blurb title={"Organizational Teams"}>
				...
				esports teams that are affiliated with high schools, universities, LAN
				centers, proven entities, etc.) have full autonomy over the structure of
				their team (i.e., their rostered players). This DOES NOT exclude players
				being removed by TES admin/staff for competitive rulings or breaking
				Discord rules.
			</Utils.Blurb>
			<Utils.RadioInput
				isInput
			...
			<Utils.Blurb title={"Team Application"}>
				We thank you for taking the time to fill out this application and look
				forward to a successful and entertaining tournament! Rules/guidelines
				are subject to change before the start of the season. All updates will
				be publicly broadcast to the TES community and Discord server.
			</Utils.Blurb>
			...
			<Utils.Blurb title={"Entry Fee"}>
				Due to increasing overhead costs for shoutcasting, marketing, and server
				costs we do require a minimal entry fee from each team's
