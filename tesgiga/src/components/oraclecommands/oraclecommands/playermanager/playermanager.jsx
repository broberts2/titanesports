...
export default (props) => {
	...
	const setup = async (selectedPlayer) => {
					...
					>
						...
						<Components.PrimaryButton
							onClick={async (myProps) => {
								...
								const verified =
									await GlobalActionsLeagueOfLegends.Requests.verifyBySummonerName(
										state.userList[state.selectedPlayer].summonerName !==
											undefined
											? state.userList[state.selectedPlayer].summonerName
											: ""
						...
						<Components.PrimaryButton
							...
							onClick={async (myProps) => {
								myProps.setSending(true);
								const verified =
									await GlobalActionsLeagueOfLegends.Requests.verifyBySummonerId(
										state.userList[state.selectedPlayer].summonerId
									);
								if (verified.id) {
									const userList = state.userList;
