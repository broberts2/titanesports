				...
				<div className={classes.builder}>
					...
					<div style={{ display: !state.radioValue ? "none" : "" }}>
						...
						>
							...
							quick drafting represented by Ocean (Blue) and Infernal (Red).
						</Components.Typography>
						<Components.Typography
							style={{
								display:
						...
						{[
							{ team: "Ocean", img: "water" },
							{ team: "Infernal", img: "fire" },
						...
						<Components.PrimaryButton
							...
							onClick={async () => {
								...
								const draft = await GlobalActions.Requests.createDraft({
									blueteam: { name: "Ocean", logo: "water" },
									redteam: { name: "Infernal", logo: "fire" },
								});
