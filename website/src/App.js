...
export default class App extends React.Component {
  ...
  async queryConfiguration() {
    ...
    const ORACLEOATH2 = config.production ? config.productionDiscordOATH2 : config.developmentDiscordOATH2;
    ...
    this.setState(Object.assign(state, {
      ...
      NICKNAME: identity ? (identity.nickname.includes('|') ? identity.nickname.split('|')[0].trim() : identity.nickname) : null,
      SUB_NAME: identity && identity.nickname.includes('|') ? identity.nickname.split('|')[1].trim() : null,
      ACCESS,
