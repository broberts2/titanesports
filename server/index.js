...
app.post(`/gitHook`, async (req, res) => {
  exec(`cd /titanesports/tesgiga; git pull origin master;`, () => {
    ...
    exec(`cd /titanesports/tesgiga; npm install;`, () => {
      ...
      exec(
        `NODE_OPTIONS=--max_old_space_size=128; cd /titanesports/tesgiga; rm -rf /var/www/html/build; rm -rf /titanesports/tesgiga/build; npm run build; mv build /var/www/html; rm -rf build`,
        () => {
